...
const textos = [
    'Los tontos que no respetan el pasado, con seguridad lo repetiran.',
    'Ser fuerte no se trata solamente de tener poder, se trata de nuestro espiritu.',
    'Tal vez nada en este mundo ocurre por accidente. Mientras todo pasa por una razon, nuestro destino toma forma lentamente.',
    'Necesitas aceptar el hecho que no eres el mejor y ten la voluntad para luchar y ser mejor que cualquiera que enfrentes.',
    'Yo sere el rey de los piratas!',
    'Los milagros solo le suceden a las personas que no se rinden.',
    'Esa cosa llamada justicia cambia su forma dependiendo de donde estes.',
];
